...
from txomon.ticket.api import ITicketActionController, TicketSystem
from txomon.ticket.model import Resolution
...
def load_workflow_config_snippet(config, filename):
    ...
    """
    filename = pkg_resources.resource_filename('txomon.ticket',
