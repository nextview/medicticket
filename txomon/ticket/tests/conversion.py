...
from txomon.ticket.web_ui import TicketModule
...
class TicketConversionTestCase(unittest.TestCase):
    ...
    def test_csv_conversion(self):
        ...
        csv = self.mimeview.convert_content(self.req, 'txomon.ticket.Ticket',
                                            ticket, 'csv')
    ...
    def test_rss_conversion(self):
        ...
        content, mimetype, ext = self.mimeview.convert_content(
            self.req, 'txomon.ticket.Ticket', ticket, 'rss')
