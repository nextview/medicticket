...
from txomon.ticket.api import TicketSystem, ITicketManipulator
from txomon.ticket.model import Milestone, Ticket, group_milestones
from txomon.ticket.notification import TicketNotifyEmail
...
class TicketModule(Component):
    ...
    def get_supported_conversions(self):
        yield ('csv', _("Comma-delimited Text"), 'csv',
               'txomon.ticket.Ticket', 'text/csv', 8)
        yield ('tab', _("Tab-delimited Text"), 'tsv',
               'txomon.ticket.Ticket', 'text/tab-separated-values', 8)
        yield ('rss', _("RSS Feed"), 'xml',
               'txomon.ticket.Ticket', 'application/rss+xml', 8)
    ...
    def get_templates_dirs(self):
        return [pkg_resources.resource_filename('txomon.ticket', 'templates')]
    ...
    def _process_ticket_request(self, req):
        ...
        if format:
            ...
            mime.send_converted(req, 'txomon.ticket.Ticket', ticket,
        ...
        for conversion in mime.get_supported_conversions('txomon.ticket.Ticket'):
            format = conversion[0]
